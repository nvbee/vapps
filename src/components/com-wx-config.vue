                        ...
                        <ul class="uplodeUl">
                            ...
                            <li>
                                <div class="uplodeDean" v-if="images.length != 10" @click="chooseImg">
                                    <img src="../assets/images/zanwu@1.5x.png" width="100%" height="100%"/>
                                </div>
...
<style scoped>
    ...
    .imgA {
        ...
        background-image: url(../assets/images/zanwu@1.5x.png);
    }
    ...
    .sommoProblemTxtP {
        margin: 0 30px;
        background: url(../assets/images/cg@2x.png) no-repeat;
        text-indent: 20px;
        background-size: 2.5%;
    ...
    .deanMailboxI {
        width: 11px;
        height: 8px;
        background-image: url(../assets/images/cg@2x.png);
